...
/**
 * Borrow from Illuminate\Console\Scheduling\Event
 */
class ScheduleJob
{
    /**
    ...
    public function buildCommand()
    {
        ...
        return $this->user && !$this->isWindows() ? 'sudo -u '.$this->user.' -- sh -c \''.$command.'\'' : $command;
    }
    ...
    {
        return sprintf('%s/%s', $this->mutexPath, 'schedule-'.sha1($this->expression.$this->command));
    }
